...
import io.jupita_kt.Jupita.Constants
import io.jupita_kt.Jupita.MessageType
...
class Requestor(context: Context, private val apiKey: String, private val touchpoint_id: String): IRequest {
    companion object {
       const val TAG = "REQUESTOR"
    }
    private val requestQueue = Volley.newRequestQueue(context)

    override fun dump(text: String, input_id: String, type: Int, isCall: Boolean, dumpListener: DumpListener?){
